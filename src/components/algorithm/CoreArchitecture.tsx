  ...
  return (
    <section className="w-full py-16">
      <div className="mx-auto max-w-6xl">
        <h2 className="text-3xl font-semibold text-primary text-left mb-4">Core Architecture</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* First 3 cards - normal width */}
          {architectureComponents.slice(0, 3).map((component) => (
            <div key={component.id} className="bg-dark-white rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
              <div className="flex flex-col">
                ...
                <h3 className="text-xl font-semibold text-primary mb-3 text-left">{component.title}</h3>
                <p className="text-sm leading-relaxed text-primary opacity-70 text-left">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
          <div className="lg:col-span-2 bg-dark-white rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
            <div className="flex flex-col">
              <div className="flex justify-center mb-4">
                <img 
                  src="/algo-arc-4.svg" 
                ...
                />
                             ...
                             <h3 className="text-xl font-semibold text-primary mb-3 text-left">Evaluation Algorithm</h3>
               <p className="text-sm leading-relaxed text-primary opacity-70 text-left">
          ...
          <div className="lg:col-span-1 bg-dark-white rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
            <div className="flex flex-col">
                             <div className="flex justify-center mb-4">
                 <img 
                   src="/algo-arc-5.svg" 
                 ...
                 />
                             ...
                             <h3 className="text-xl font-semibold text-primary mb-3 text-left">Data Security</h3>
               <p className="text-sm leading-relaxed text-primary opacity-70 text-left">
