  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 flex flex-col lg:flex-row gap-6 lg:gap-8 items-stretch h-auto">
      ...
      <div className="bg-brand-bg w-full lg:w-7/12 h-auto rounded-xl p-6 sm:p-8 lg:py-16 lg:px-10">
        <h2 className="text-2xl sm:text-3xl font-medium text-primary mb-4 sm:mb-6 text-center lg:text-left">
          Intuitive Dashboard
        </h2>
        <div className="flex items-center gap-2 w-full">
          ...
          <img src="/int-dash.svg" alt="" className="w-1/2 object-contain" />
        </div>
      ...
      {/* Right Image */}
      <div className="flex flex-col justify-center bg-brand-bg p-4 sm:p-6 lg:p-6 rounded-xl text-primary w-full lg:w-5/12 h-64 sm:h-80 lg:h-full">
