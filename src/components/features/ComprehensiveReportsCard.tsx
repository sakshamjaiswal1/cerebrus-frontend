...
const ComprehensiveReportsCard = () => {
  return (
    <div className="bg-brand-bg rounded-xl p-8 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
      {/* Left Content */}
      <div>
        <h2 className="text-3xl font-semibold text-primary mb-6">Comprehensive Reports</h2>
        <p className="text-base leading-relaxed text-primary opacity-70 mb-6">
          Get a complete view of every candidate with clear organized reports. Watch the interview recording and get overall performance 
          metrics. Detailed analytics provide insights for informed decision making.
        </p>
        <p className="text-base leading-relaxed text-primary opacity-70 mb-8">
          ...
          notice period, red flags and more are and customized like a personal interview 
          summary.
        </p>
