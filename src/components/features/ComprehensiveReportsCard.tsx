...
const ComprehensiveReportsCard = () => {
  ...
  return (
    <div className="bg-brand-bg rounded-xl p-4 lg:pb-0 sm:p-6 lg:p-8 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center overflow-hidden group hover:cursor-pointer">
      {/* Right Image */}
      <div className="flex justify-center overflow-hidden  transition-all duration-500 ease-out group-hover:scale-105">
        <img
          src="/report-comp.svg"
      ...
      <div className="text-left overflow-hidden">
        <div className="transform transition-all duration-500 ease-out group-hover:translate-x-4">
