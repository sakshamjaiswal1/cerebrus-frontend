      ...
      <div className="mx-auto border border-gray-700 rounded-2xl p-8 bg-[#ffffff15]">
        <div className="flex flex-col lg:flex-row-reverse gap-12 items-center">
          <div className="lg:w-1/2">
            <h2 className="text-4xl font-bold text-white mb-8">Responsive By Design</h2>
            <p className="text-lg text-gray-300 mb-8">
              Because our MetaHuman interviewer connects directly and responds to our AI engine, it naturally responds in subtle ways:
            </p>
