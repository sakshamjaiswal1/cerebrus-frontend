          ...
          <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 lg:gap-12">
            <div className="w-full lg:w-1/3">
              <div className="space-y-4 sm:space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-3 sm:space-x-4 pb-3 sm:pb-4 border-b border-gray-300">
                    <div className="flex-shrink-0 w-6 h-6 sm:w-8 sm:h-8 bg-primary-light rounded-full flex items-center justify-center text-primary text-xs sm:text-sm font-medium">
                      {index + 1}
                    </div>
                    <p className="text-sm sm:text-base text-primary pt-1">{item}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="w-full lg:w-2/3">
              <div className="space-y-4 sm:space-y-6">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-primary mt-6 sm:mt-8 mb-3 sm:mb-4">
                  Lorem Ipsum is simply dummy
                </h3>
