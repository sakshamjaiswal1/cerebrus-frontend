...
const JobCard: React.FC<JobCardProps> = ({ title, experience }) => {
    return (
        <div className="bg-white hover:bg-brand-bg rounded-2xl p-4 sm:p-6 flex flex-row items-center justify-between shadow-sm gap-3 sm:gap-4">
            <div className="flex-1 min-w-0">
                ...
                <div className="sm:hidden">
                    <AnimatedButton text="Apply" className="!border !border-primary !bg-transparent !text-[10.5px]" />
                </div>
