  ...
  return (
    <section className="w-full py-8 sm:py-12 lg:py-16">
      <div className="mx-auto px-4 sm:px-6 lg:px-0">
        <div className="bg-brand-bg rounded-2xl p-4 sm:p-6 lg:p-8 border border-gray-300">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 sm:gap-6 lg:gap-8">
            
            {/* Left Side - Text Content */}
            <div className="w-full lg:w-11/12">
              <h2 className="text-lg sm:text-xl lg:text-5xl text-primary leading-tight mb-2 sm:mb-4">
